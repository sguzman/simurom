...
- [x] Assets (M0): Normalize backslashes `\` in relative asset paths to
  forward slashes `/` on Windows 11 to allow Bevy's `AssetServer` to
  locate and load assets successfully.
