...
def main():
    ...
    # Generate brows layer
    brows = transform_layer("assets/mini_game/images/blonde_eyebrows.png", base_size, 0.24, 10.25, -25.0, 380.0)
    ...
    composite.save("scratch/composite_full_test.png")
    
    # Crop head/face region
    crop = composite.crop((450, 100, 800, 450))
    crop.save("scratch/composite_full_head.png")
    print("Saved composite head to scratch/composite_full_head.png")
